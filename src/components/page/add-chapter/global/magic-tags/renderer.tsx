          ...
          switch (type) {
            ...
            case "stealth":
              return (
                <div
                  key={index}
                  className="relative bg-linear-to-br from-card/95 via-muted/90 to-card/95 border-2 border-border/50 text-muted-foreground px-5 py-4 rounded-xl shadow-xl overflow-hidden animate-fade-to-shadow"
                >
